...
public class StackGraphPanel extends JPanel {
    ...
    private Map<Stack, StatisticAccumulator> values;
    ...
    private DataTypeHelper helper = new SocketIOHelper();
    ...
    public void updateModel(String type, Map<Stack,StatisticAccumulator> values) {
        this.values = values;
        this.model = null;
        this.boxes = null;
        this.image = null;
        this.helper = DataTypeHelper.forType(type);
        repaint();
    }
    ...
    public String getToolTipText(MouseEvent event) {
        ...
        return box==null ? null : box.getToolTipText(helper);
    }
    ...
    private void updateDetails(Box box) {
        ...
        detailField.setText(box.getDetailText(helper));
    }
