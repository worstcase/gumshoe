...
public class ProbeSourcePanel extends JPanel implements Listener<StatisticAccumulator> {
    private static final SimpleDateFormat hms = new SimpleDateFormat("HH:mm:ss");

    private String lastReceivedType;
    private Map<Stack,StatisticAccumulator> lastReceivedStats;
...
//        acceptPanel.add(acceptFileIO);
    ...
    private boolean canAccept(String type, Map<Stack,StatisticAccumulator> stats) {
    ...
    @Override
    public synchronized void statsReported(String type, Map<Stack,StatisticAccumulator> stats) {
    ...
    private void relayStats(Sample sample) {
        ...
        parent.setSample(sample.type, sample.data);
    }
    ...
    private static class Sample {
        ...
        String time;
        String type;
        Map<Stack,StatisticAccumulator> data;

        public Sample(String type, Date sampleTime, Map<Stack,StatisticAccumulator> data) {
