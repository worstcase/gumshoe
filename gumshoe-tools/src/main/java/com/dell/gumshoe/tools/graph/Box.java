...
class Box {
    ...
    public String getToolTipText(DataTypeHelper helper) {
        return helper.getToolTipText(boxNode, parentNode);
    }

    public String getDetailText(DataTypeHelper helper) {
        return helper.getDetailText(boxNode, parentNode);
    }
